setwd("C:/Users/geo_jahe/R_scripts/git/brandsat/")
...
fires_comments <- fires_comments[!fires_comments$plotid %in% wind_exclude,]
...
# bb_interpretations %>% group_by(change_process) %>% tally()
