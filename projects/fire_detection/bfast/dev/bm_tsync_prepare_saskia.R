...
bm_tsync_prepare <- function(df_inters, df_comments, out_csv_file, overwrite=F) {
  ...
  df_inters$change_process_brandsat[df_inters$change_process == "Wind"]       <- "Harvest"
  df_inters$change_process_brandsat[df_inters$change_process == "Other"]      <- "Other"
  df_inters$change_process_brandsat[df_inters$change_process == "Hydrology"]  <- "Other"
  df_inters$change_process_brandsat[df_inters$change_process == "Fire"]       <- "Fire"
  df_inters$change_process_brandsat[df_inters$change_process == "BarkBeetle"] <- "BarkBeetle"
  df_inters$change_process_brandsat[df_inters$change_process == "Decline"]    <- "Decline"
