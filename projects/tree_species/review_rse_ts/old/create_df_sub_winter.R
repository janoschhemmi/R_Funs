...
df_features <- read.table("Kernel_6/df_features_kernel6.csv", sep = ";", dec =".", header = TRUE)
...
write.table(df_features_sub, "Kernel_6/df_features_winter_sub.csv", sep =";", dec=".", col.names = TRUE)
