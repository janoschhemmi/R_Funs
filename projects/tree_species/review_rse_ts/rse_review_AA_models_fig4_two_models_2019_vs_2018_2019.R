...
p_spec <- ggplot2::ggplot(result, aes(class, accuracy, fill=src)) + 
  ...
  scale_fill +
  ggtitle("Model 2018+2019 (550 features)") +
...
p_dif <- ggplot2::ggplot(result_2_env, aes(class, accuracy, fill=src)) + 
  ...
  ggtitle("Difference to model 2019 (400 features)") +
...
setwd("P:/workspace/treespecies/_review/model/feature_reduction_env_txt/2019/")
ggsave("split_2018_2019_vs_split_2019_bars.png",grid_plot, width = 14, height = 6,dpi = 600
) ## width == 12 
